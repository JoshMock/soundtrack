...
"use strict";module.exports={getFrameData:function(t){var e=document.createElement("canvas"),a=e.getContext("2d");return e.width=t.width,e.height=t.height,a.drawImage(t,0,0,t.width,t.height),a.getImageData(0,0,t.width,t.height).data}};
},{}],2:[function(require,module,exports){
"use strict";var _=require("lodash");module.exports={averageColor:function(r){var o=r.length/4,e=[0,0,0];return _.each(_.range(o),function(o){e[0]=e[0]+r[4*o],e[1]=e[1]+r[4*o+1],e[2]=e[2]+r[4*o+2]}),[Math.floor(e[0]/o),Math.floor(e[1]/o),Math.floor(e[2]/o)]},brightness:function(r){var o=this.averageColor(r);return.299*o[0]+.587*o[1]+.114*o[2]}};
},{"lodash":5}],3:[function(require,module,exports){
"use strict";function successCallback(e){var a=document.querySelector("video");a.src=window.URL?window.URL.createObjectURL(e):e;new NoiseMaker(a)}function errorCallback(e){console.log("navigator.getUserMedia error:",e)}var NoiseMaker=require("./noisemaker");navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia,navigator.getUserMedia({audio:!1,video:!0},successCallback,errorCallback);
},{"./noisemaker":4}],4:[function(require,module,exports){
"use strict";var canvasUtils=require("./canvas-utils"),imageMath=require("./image-math"),_=require("lodash"),testConfig=[{nodeType:"Oscillator",type:"SAWTOOTH",frequency:440,onVideoChange:function(e){this.frequency.value=e.brightness*e.brightness/70}},{nodeType:"WaveShaper",onVideoChange:function(e){for(var t,i=e.averageColor[1],n=44100,a=new Float32Array(n),o=Math.PI/180,r=0;n>r;++r)t=2*r/n-1,a[r]=(3+i)*t*20*o/(Math.PI+i*Math.abs(t));this.curve=a}},{nodeType:"Gain",gain:1,onVideoChange:function(e){this.gain.value=1/e.averageColor[0]}}],NoiseMaker=function(e){this.video=e,this._init(testConfig),this._chain=[]};NoiseMaker.prototype._init=function(e){var t=window.AudioContext||window.webkitAudioContext,i=new t,n=[],a=[];_.each(e,function(e){var t=i["create"+e.nodeType]();_.each(e,function(i,n){"nodeType"!==n&&("Oscillator"===e.nodeType&&"type"===n?t[n]=t[i]:"onVideoChange"===n?a.push(i.bind(t)):t[n].value=i)}),n.push(t),n.length>1&&n[n.length-2].connect(t),t.start&&t.start(0)}),_.last(n).connect(i.destination),this.intervalId=setInterval(function(){var e=canvasUtils.getFrameData(this.video,this.video.width,this.video.height),t={brightness:imageMath.brightness(e),averageColor:imageMath.averageColor(e)};_.each(a,function(e){e(t)})}.bind(this),100)},module.exports=NoiseMaker;
...
//# sourceMappingURL=/build/js/main.min.map